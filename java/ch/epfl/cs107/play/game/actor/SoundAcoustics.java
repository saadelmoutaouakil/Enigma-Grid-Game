...
public class SoundAcoustics implements Acoustics {
	 ...
	 * 
	 * @param name
	 *            (String): name of the sound without path and extension. May be
	 *            bull
	 * @param volume
	 *            (float): 0.0f no sound, 1.0f full audio
	 * @param fadeIn
	 *            (boolean): indicate if the song fade in until reaching its max
	 *            volume
	 * @param randomFirstStart
	 *            (boolean): indicate if the first start is random in the sound
	 * @param loop
	 *            (boolean): indicate if the sound must loop on self ending
	 * @param stopOthersOnStart
	 *            (boolean): indicate if all other sound are stopped on given
	 *            sound's start
	 */
	 ...
	 * 
	 * @param audio
	 *            (Audio): given audio context. Not null
	 */
