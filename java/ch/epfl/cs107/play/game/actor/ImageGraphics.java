...
public class ImageGraphics extends Node implements Graphics {
	 ...
	 * @param roi
	 *            (RegionOfInterest): region of interest as a rectangle in the image
	 * @param anchor
	 ...
	 *            (boolean): indicate if we need to remove the uniform color
	 *            background before using this image
	 */
	 ...
	 * 
	 * @param name
	 *            (String): new image name, may be null
	 */
