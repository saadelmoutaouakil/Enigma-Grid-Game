...
public class GraphicsEntity extends Entity {
	 ...
	 * 
	 * @param position
	 *            (Vector): Initial position of the entity. Not null
	 * @param graphics
	 *            (Graphics): graphics to display at position. Not null
	 */
	 ...
	 * 
	 * @param position
	 *            (Vector): initial Position. Not null
	 * @param graphics
	 *            (ImageGraphics): graphics to display at position. Not null
	 */
	 ...
	 *            (Vector): initial Position. Not null
	 * @param graphics
	 *            (TextGraphics): graphics to display at position. Not null
	 */
	 ...
	 *            (Vector): initial Position. Not null
	 * @param graphics
	 *            (ShapeGraphics): graphics to display at position. Not null
	 */
