...
public final class RegionOfInterest implements Serializable {
	 ...
	 * 
	 * @param x
	 *            (int) top left pixel x coordinate in the image coordinate system
	 * @param y
	 *            (int) top left pixel y coordinate in the image coordinate system
	 * @param w
	 *            (int) width in number of pixel
	 * @param h
	 *            (int) height in number of pixel
	 */
