...
public final class Vector implements Serializable {
	...
	/**
	 * @param other
	 *            (Vector): right-hand operand, not null
	...
	/**
	 * @param x
	 *            (float): right-hand abscissa
	 * @param y
	 *            (float): right-hand ordinate
	 * @return (Vector): sum, not null
	 */
	 ...
	 * 
	 * @param normal
	 *            (Vector): vector perpendicular to the symmetry plane, not null
	 ...
	 * 
	 * @param other
	 *            (Vector): second vector, not null
	 * @param factor
	 *            (float) weight of the second vector
