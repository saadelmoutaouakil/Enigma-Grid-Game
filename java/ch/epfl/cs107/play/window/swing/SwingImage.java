...
public final class SwingImage implements Image {
	 ...
	 * 
	 * @param image
	 *            (java.awt.Image): valid image to be copied, not null
	 * @param roi
	 *            (RegionOfInterest): rectangle of interest in the image, may be
	 *            null
	 * @param removeBackground
	 *            (boolean): which indicate if need to remove an uniform background
	 */
	 ...
	 * 
	 * @param stream
	 *            (InputStream): valid image input stream, not null
	 * @param roi
	 *            (RegionOfInterest): rectangle of interest in the image, may be
	 *            null
	 * @param removeBackground
